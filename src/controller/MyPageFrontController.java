...
public class MyPageFrontController extends HttpServlet {
	...
	protected void doProcess(HttpServletRequest request, HttpServletResponse response)
		...
		} else if (command.equals("/adminMemberDeletePro.bg")) {// 관리자 회원 전체 리스즈 조회 삭제 요청
		...
		} else if (command.equals("/adminMemberListDeleteConfirm.bg")) {// 관리자 회원 전체 리스즈 조회 삭제 요청 후 포인트 소지 회원 삭제 질문 폼
			forward = new ActionForward();
			forward.setPath("mypage/adminMemberListDeleteConfirm.jsp");
		} else if (command.equals("/adminMemberDeletePointPro.bg")) {// 관리자 회원 전체 리스즈 조회 삭제 요청 후 포인트 소지 회원 삭제 질문에 대한 답이 Y
		...
		} else if (command.equals("/adminMemberListDeleteSuccess.bg")) {// 관리자 회원 전체 리스즈 조회 삭제 성공 폼
			forward = new ActionForward();
		...
		} else if (command.equals("/adminIOPro.bg")) {// 입고 요청 ------------- 수정중
		...
		} else if (command.equals("/adminProductListForm.bg")) {// 아이스크림 + 물건 전체 폼(아이스크림 등록만될시 수정)
